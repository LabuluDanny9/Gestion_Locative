...
export type Unit = {
  ...
  currency: "USD" | "CDF";
  status: UnitStatus;
  tenant?: { id: string; name: string; code: string; contractId: string; contractStart: string; contractEnd: string };
  image: string;
...
export const units: Unit[] = [
  ...
  { id: "studio-b01", code: "B01", type: "Studio", propertyId: "residence-grace", propertyName: "Résidence Grâce", building: "Bâtiment B", floor: "Rez-de-chaussée", bedrooms: 1, livingRooms: 0, bathrooms: 1, kitchens: 1, area: 42, rent: 240, currency: "USD", status: "occupied", tenant: { id: "grace-tshibangu", name: "Grâce Tshibangu", code: "LOC-2026-0018", contractId: "ctr-2026-0031", contractStart: "01/07/2026", contractEnd: "30/06/2027" }, image: propertyImage },
  ...
  { id: "villa-m01", code: "M01", type: "Maison", propertyId: "villa-mwezi", propertyName: "Villa Mwezi", building: "Maison principale", floor: "Duplex", bedrooms: 4, livingRooms: 2, bathrooms: 3, kitchens: 1, area: 240, rent: 1200, currency: "USD", status: "occupied", tenant: { id: "patrick-mwamba", name: "Patrick Mwamba", code: "LOC-2025-0096", contractId: "ctr-2025-0096", contractStart: "01/12/2025", contractEnd: "30/11/2026" }, image: propertyImage },
  { id: "appartement-u12", code: "U12", type: "Appartement", propertyId: "immeuble-upemba", propertyName: "Immeuble Upemba", building: "Tour principale", floor: "4e étage", bedrooms: 2, livingRooms: 1, bathrooms: 1, kitchens: 1, area: 76, rent: 420, currency: "USD", status: "occupied", tenant: { id: "amina-kasongo", name: "Amina Kasongo", code: "LOC-2025-0072", contractId: "ctr-2026-0058", contractStart: "05/11/2025", contractEnd: "04/11/2026" }, image: propertyImage },
];
