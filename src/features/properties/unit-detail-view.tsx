...
export function UnitDetailView({ unit, basePath, propertyBasePath, dashboardHref }: { unit: Unit; basePath: string; propertyBasePath: string; dashboardHref: string }) {
