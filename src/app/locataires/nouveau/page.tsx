...
export default async function NewTenantPage({ searchParams }: { searchParams: Promise<{ erreur?: string }> }) {
  ...
  return <ProtectedAppShell><MutationFeedback error={params.erreur} /><TenantFormPreview action={createTenantAction} basePath="/locataires" dashboardHref="/espace" /></ProtectedAppShell>;
}
