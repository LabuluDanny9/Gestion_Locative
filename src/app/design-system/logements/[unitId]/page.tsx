...
export default async function UnitDetailPreviewPage({ params }: { params: Promise<{ unitId: string }> }) {
  ...
  if (!unit) notFound();
  return <AppShell displayName="Gestionnaire" preview previewHomeHref="/design-system/dashboard"><UnitDetailView basePath="/design-system/logements" dashboardHref="/design-system/dashboard" propertyBasePath="/design-system/proprietes" tenantBasePath="/design-system/locataires" unit={unit} /></AppShell>;
}
