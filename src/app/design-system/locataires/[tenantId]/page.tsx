...
export default async function TenantDetailPreviewPage({ params }: { params: Promise<{ tenantId: string }> }) {
  ...
  if (!tenant) notFound();
  return <AppShell displayName="Gestionnaire" preview previewHomeHref="/design-system/dashboard"><TenantDetailView basePath="/design-system/locataires" dashboardHref="/design-system/dashboard" tenant={tenant} unitBasePath="/design-system/logements" /></AppShell>;
}
